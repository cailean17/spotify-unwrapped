...
const APIController = (function() {
    ...
    const _getRecommendations= async(token, trackFeatures) => {
        ...
        const result = await fetch(`https://api.spotify.com/v1/recommendations?seed_tracks=${trackFeatures.id}&limit=3&target_tempo=${trackFeatures.tempo}`,{
            method:'GET',
            headers:{
                'Authorization' : 'Bearer ' + token
            }
       ...
       async populateTopTracksList(track1, track2, track3, track1analysis, track2analysis, track3analysis, track_playback_function, recommendation_function, token){
            ...
            <div class = "row>
              <div class="col-xs pe-4">
                ...
                <div class = "xop-box-small px-4" style = "background:url(${recommendations.tracks[1].album.images[0].url}) center/100px 100px no-repeat; cursor:pointer">
