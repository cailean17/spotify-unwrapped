           ...
           artist =  document.querySelector(DOMElements.search_bar_track_recommendation_artist).value;
            ...
            <div class = "row>
              ...
              <p class = "lead"> ${search_query.tracks.items[0].name}</p>
                ...
                <div class = "col-xs ps-4 ">
                <div class = "xop-box-small" id = "track1_recommendation3album"  style = "background:url(${recommendations.tracks[0].album.images[0].url}) center/100px 100px no-repeat; cursor:pointer">
